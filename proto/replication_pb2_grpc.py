...
from proto import replication_pb2 as replication__pb2
...
class ReplicationServiceStub(object):
    """Service for ledger replication
    """
    ...
    def __init__(self, channel):
        ...
        """
        self.ReplicateLedger = channel.unary_unary(
                '/replication.ReplicationService/ReplicateLedger',
...
def add_ReplicationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ReplicateLedger': grpc.unary_unary_rpc_method_handler(
                    servicer.ReplicateLedger,
